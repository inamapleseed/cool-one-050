...
<?php if(!$not_avail) { ?>
    <?php if ($options): ?>
      <div class="time-date-options">
        <?php foreach ($options as $option): ?>
        <?php if ($option['type'] == 'date') { ?>
          <div class="form-group<?= ($option['required'] ? ' required' : ''); ?>">
            <label class="control-label" for="input-option<?= $option['product_option_id']; ?>"><?= $option['name']; ?></label>
            <div class="input-group date">
              <input type="text" name="option[<?= $option['product_option_id']; ?>]" value="<?= $option['value']; ?>" data-date-format="YYYY-MM-DD" id="input-option<?= $option['product_option_id']; ?>" class="form-control" placeholder="Select Date"/>
          ...
          <div class="form-group<?= ($option['required'] ? ' required' : ''); ?>">
            ...
            <div class="input-group time">
              <input type="text" name="option[<?= $option['product_option_id']; ?>]" value="<?= $option['value']; ?>" data-date-format="HH:mm" id="input-option<?= $option['product_option_id']; ?>" class="form-control" placeholder="Select Time"/>
              <span class="input-group-btn">
              <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
              </span></div>
          </div>
...
<?php } ?>
    ...
    <div class="form-group addcart-share-wrapper">
      <input type="hidden" name="product_id" value="<?= $product_id; ?>" /> 
      <div class="addcart-share-wrapper2"> 
      <?php if(!$enquiry){ ?>
        <?php if(!$not_avail) { ?>
      ...
      <?php } ?>
       ...
       <?php if($share_html){ ?>
          <div class="input-group-flex product-share">
            <span><?= $text_share; ?></span>
            <div class="share-icons"><?= $share_html; ?></div>
          </div>
        <?php } ?>
       </div>
