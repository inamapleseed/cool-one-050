...
<div class="container">
	...
	<div class="row product-container"><?= $column_left; ?>
	...
	<div id="content" class="<?= $class; ?>">
		<h2 class="product-title"><?php // echo $heading_title; ?>Shop Services</h2>
		<div class="row">
			<?php if ($column_left || $column_right) { ?>
				<?php $class = 'col-sm-6'; ?>
			<?php } else { ?>
				<?php $class = 'col-sm-6'; ?>
			<?php } ?>
			<div class="<?= $class; ?> col-lg-5 pd-lg-r60">
...
<!-- FACEBOOK EVENT - CALLING SCRIPTS -->
<?php if (isset($facebook_events) ) { ?>
	<?= $facebook_events?>
<?php } ?>
<!-- FACEBOOK EVENT - CALLING SCRIPTS END -->
