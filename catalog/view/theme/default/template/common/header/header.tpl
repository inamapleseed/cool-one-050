			...
			<div class="header-container">
				<div class="header-mobile-links visible-xs visible-sm">
					<div class="header-links">
						...
						<span class="hidden-xs hidden-sm test">
							<?php // echo $pop_up_search; ?>
						</span>
					</div>
				</div>

				<div class="header-top" style="display:none">
					<div hidden class="search_container">
						<span class="hidden-xs hidden-sm"><?= $pop_up_search; ?></span>
					</div>
		...
		<div class="floating-social-icons">
			<?php foreach($social_icons as $icon){ ?>
				...
				<?php if($icon['title'] == 'Call Us Now'):?>
					<a href="tel:<?= $icon['link']; ?>" title="<?= $icon['title']; ?>" alt="<?= $icon['title']; ?>" target="_blank">
						<img src="<?= $icon['icon']; ?>" title="<?= $icon['title']; ?>" class="img-responsive" alt="<?= $icon['title']; ?>" />
                    </a>
				<?php endif ?>
			<?php } ?>
